...
class Ministral3DSparkAttention(nn.Module):
...
class Ministral3DSparkDecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size
        self.self_attn = Ministral3DSparkAttention(config=config, layer_idx=layer_idx)
...
class Ministral3DSparkModel(Ministral3PreTrainedModel):
    _no_split_modules = ["Ministral3DSparkDecoderLayer"]
    ...
    def __init__(self, config) -> None:
        ...
        self.layers = nn.ModuleList(
            [
                Ministral3DSparkDecoderLayer(config, layer_idx)
...
__all__ = [
    ...
    "Ministral3DSparkAttention",
    "Ministral3DSparkDecoderLayer",
]
