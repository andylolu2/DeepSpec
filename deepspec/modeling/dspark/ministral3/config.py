...
def build_draft_config(
    ...
    assert target_config.model_type == "mistral3", (
        "Ministral3 DSpark expects the top-level Mistral3 target config, "
    ...
    assert text_config.model_type == "ministral3", (
        "Ministral3 DSpark expects target_config.text_config.model_type to be "
    ...
    draft_config.architectures = ["Ministral3DSparkModel"]
